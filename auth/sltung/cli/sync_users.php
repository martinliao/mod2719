 ...
 * Sample cron entry:
 * # 5 minutes past 4am
 * 5 4 * * * sudo -u www-data /usr/bin/php /var/www/moodle/auth/sltung/cli/sync_users.php
 *
 * Notes:
...
The auth_sltung plugin must be enabled and properly configured.
...
Example:
\$ sudo -u www-data /usr/bin/php auth/sltung/cli/sync_users.php
...
if (!is_enabled_auth('sltung')) {
    cli_error('auth_sltung plugin is disabled, synchronisation stopped', 2);
}
...
/** @var auth_plugin_sltung $dbauth */
$dbauth = get_auth_plugin('sltung');
